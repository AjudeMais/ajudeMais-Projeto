...
query = "SELECT ms.mensageiro,e.id FROM MensageiroAssociado ms JOIN FETCH ms.mensageiro.enderecos e WHERE e.bairro like :bairro and e.localidade like :localidade"
