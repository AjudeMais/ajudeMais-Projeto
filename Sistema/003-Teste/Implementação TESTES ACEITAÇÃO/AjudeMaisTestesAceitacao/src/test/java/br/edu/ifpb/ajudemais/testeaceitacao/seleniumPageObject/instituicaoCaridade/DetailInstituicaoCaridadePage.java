...
public class DetailInstituicaoCaridadePage extends InstituicaoCaridadePage{
	...
	public boolean validateFields(String nome, String descricao,String documento, String telefone, String email, String cep,
		...
		boolean validateLogradouro = $(By.xpath("//*[@id=\"content-wrapper\"]/div/div[3]/div/div/div[1]/div[4]/div[1]/div[1]/div/table/tbody/tr[1]/td")).getText().equals(logradouro);
		
		boolean validateNumero = $(By.xpath("//*[@id=\"content-wrapper\"]/div/div[3]/div/div/div[1]/div[4]/div[1]/div[1]/div/table/tbody/tr[2]/td")).getText().equals(numeroEndereco);
		
		boolean validateBairro = $(By.xpath("//*[@id=\"content-wrapper\"]/div/div[3]/div/div/div[1]/div[4]/div[1]/div[1]/div/table/tbody/tr[3]/td")).getText().equals(bairro);
			
		boolean validateComplemento = $(By.xpath("//*[@id=\"content-wrapper\"]/div/div[3]/div/div/div[1]/div[4]/div[1]/div[2]/div/table/tbody/tr[1]/td")).getText().equals(complemento);
		
		boolean validateEmail = $(By.xpath("//*[@id=\"content-wrapper\"]/div/div[3]/div/div/div[1]/div[4]/div[3]/div/div/table/tbody/tr[1]/td")).getText().equals(email);
